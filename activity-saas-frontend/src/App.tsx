...
const pages = { dashboard: { title: 'Overview', sub: 'Welcome back', component: Dashboard }, onboarding: { title: 'Onboarding', sub: 'Complete verification to unlock full catalogue access', component: Onboarding }, listings: { title: 'Products', sub: 'Manage products, revisions, variants and rate plans', component: Products }, availability: { title: 'Inventory', sub: 'Manage schedules, capacity, blackouts and operational resources', component: Inventory }, bookings: { title: 'Bookings', sub: 'Confirm, track and fulfil incoming reservations', component: Bookings }, fulfilment: { title: 'Fulfilment', sub: 'Service-day operations, evidence and vouchers', component: FulfilmentCentre }, payouts: { title: 'Payouts', sub: 'Track earnings and settlement cycles', component: Payouts }, performance: { title: 'Performance', sub: 'SLA, ratings and operational quality', component: Performance } } as const;
type VendorPage = keyof typeof pages;
type AdminPage = 'dashboard' | 'vendors' | 'review' | 'commercial' | 'eligibility' | 'bookings' | 'refunds' | 'fulfilment' | 'settlements' | 'quality';
