...
type AdminPage = 'dashboard' | 'vendors' | 'review' | 'commercial' | 'eligibility' | 'bookings' | 'refunds' | 'fulfilment' | 'settlements' | 'quality' | 'demand';
...
function AdminApp({ user, logout }: { user: User; logout: () => void }) {
  ...
  const nav: Array<[AdminPage, string]> = [['dashboard', 'Dashboard'], ['vendors', 'Vendors'], ['review', 'Product Review'], ['bookings', 'Bookings'], ['fulfilment', 'Fulfilment'], ['refunds', 'Refunds'], ['commercial', 'Commercial'], ['settlements', 'Settlements'], ['eligibility', 'Eligibility'], ['quality', 'Quality'], ['demand', 'Demand']];
