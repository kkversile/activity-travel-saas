...
const finance: Permission[] = ['vendor.profile.view', 'document.view', 'payout.view', 'fulfilment.view.vendor'];
...
export function permissionsFor(user: Pick<AuthUser, 'role' | 'organizationRole'>): Set<Permission> {
  ...
  const roleMap: Record<OrganizationRole, Permission[]> = { OWNER: ['vendor.profile.view', 'vendor.profile.edit', 'document.view', 'document.upload', 'product.view', 'product.edit', 'product.submit', 'rateplan.view', 'rateplan.edit', 'inventory.view', 'inventory.edit', 'schedule.view', 'schedule.edit', 'resource.view', 'resource.edit', 'booking.view', 'booking.confirm', 'booking.cancel', 'booking.cancel.vendor', 'booking.view.vendor', 'booking.confirm.vendor', 'booking.reject.vendor', 'payout.view', 'audit.view', 'commercial.vendor.view', 'commercial.vendor.edit', 'fulfilment.view.vendor', 'fulfilment.edit.vendor', 'manifest.view', 'manifest.checkin'], CATALOGUE: [...catalogue, 'booking.view.vendor', 'fulfilment.view.vendor'], OPERATIONS: [...operations, 'booking.view.vendor', 'booking.confirm.vendor', 'booking.reject.vendor', 'booking.cancel.vendor'], FINANCE: [...finance, 'booking.view.vendor', 'refund.view'], VIEWER: [...viewer, 'booking.view.vendor'] };
