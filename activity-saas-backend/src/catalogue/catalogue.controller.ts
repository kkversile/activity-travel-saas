...
import { ArchiveVariantDto, BookingQuestionDto, CreateProductDto, CreateProductDraftDto, CreateProductRevisionDto, ProductListingQueryDto, ProductMediaDto, ProductMediaUploadDto, ProductQueryDto, RejectProductRevisionDto, UpdateBookingQuestionDto, UpdateProductMediaRankDto, UpdateProductRevisionDto, UpdateVariantDto, VariantDto } from './catalogue.dto';
...
export class CatalogueController {
  ...
  @Get('products/listing') @Permissions('product.view') listing(@CurrentUser() user: AuthUser, @Query() query: ProductListingQueryDto) { return this.service.listing(user, query); }
  ...
  @Post('products/drafts') @Permissions('product.edit') createDraft(@CurrentUser() user: AuthUser, @Body() dto: CreateProductDraftDto) { return this.service.createDraft(user, dto); }
  @Get('products/:productId/readiness') @Permissions('product.view') readiness(@CurrentUser() user: AuthUser, @Param('productId') id: string) { return this.service.readiness(user, id); }
  ...
  @Patch('product-revisions/:revisionId/media/:mediaId') @Permissions('product.edit') rankMedia(@CurrentUser() user: AuthUser, @Param('revisionId') id: string, @Param('mediaId') mediaId: string, @Body() dto: UpdateProductMediaRankDto) { return this.service.rankMedia(user, id, mediaId, dto); }
