...
import { ArchiveVariantDto, CreateProductDto, CreateProductRevisionDto, ProductMediaDto, ProductMediaUploadDto, ProductQueryDto, RejectProductRevisionDto, UpdateProductRevisionDto, UpdateVariantDto, VariantDto } from './catalogue.dto';
